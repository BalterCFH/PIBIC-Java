 ...
 * @author Pedro Elias
 */
public class Nova_Tela_Relatorio_RU extends javax.swing.JInternalFrame {
    ...
    public String preco_venda() {
        try {
            String sql2 = "select sum(preco_total_ru) as preco_total from preco_venda_evento";            
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            sql = "select * from produtos_ru where competencia between '" + data1 + "' and '" + data2+"'";                        
            System.out.println("select * from produtos_ru where competencia between '" + data1 + "' and '" + data2+"'");
        ...
        try {
            ...
            String arquivo="src\\Relatorio\\Produtos_3_RU.jasper";
    ...
    private void botao_cancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_cancelarActionPerformed
        Nova_Tela_Relatorio_RU tela = new Nova_Tela_Relatorio_RU();
        tela.dispose();
