 ...
 * @author Pedro Elias
 */
public class Nova_Tela_Relatorio_Eventos extends javax.swing.JInternalFrame {
    ...
    public Nova_Tela_Relatorio_Eventos() {
        initComponents();
        setResizable(false);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            sql = "select * from produtos_eventos where competencia between '" + data1 + "' and '" + data2+"'";                        
            System.out.println("select * from produtos_eventos where competencia between '" + data1 + "' and '" + data2+"'");
        ...
        try {
            ...
            String arquivo="src\\Relatorio\\Produtos_3_Eventos.jasper";
            HashMap parametros = new HashMap<>();
            parametros.put("data_inicio",data1);
            ...
            JOptionPane.showMessageDialog(null, "Erro de Emissão de Relatórios_1: " + ex.getMessage());
        }
        catch(JRException erro){
            JOptionPane.showMessageDialog(null, "Erro de Emissão de Relatórios_1: " + erro.getMessage());
        }
        catch(NullPointerException error){
            JOptionPane.showMessageDialog(null,"Erro de não passagem de parâmetro:"+error.getMessage());
        }
    ...
    private void botao_cancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_cancelarActionPerformed
        Nova_Tela_Relatorio_Eventos tela = new Nova_Tela_Relatorio_Eventos();
        tela.dispose();
