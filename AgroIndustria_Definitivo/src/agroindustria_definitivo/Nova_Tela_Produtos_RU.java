 ...
 * @author aluno
 */
public class Nova_Tela_Produtos_RU extends javax.swing.JInternalFrame {

    private PreparedStatement pst = null;
    private ResultSet rs = null;
    private Connection con;

    public Nova_Tela_Produtos_RU() {
        initComponents();
    ...
    final void InserirTable() {
        ...
        try {
            ...
            modelo.setNumRows(0);
            while (rs.next()) {
                modelo.addRow(new Object[]{rs.getInt("id"), rs.getString("unidade"), rs.getString("nome_prod"), rs.getString("quantidade"), rs.getString("valor"),rs.getString("competencia")});
            }
    ...
    public double retorna_valor_total() {
        String soma=null;
        try {
            String sql = "select sum(valor) as total_produtos_ru from produtos_ru";
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
            if(rs.next()){
                 soma = rs.getString(1);
    ...
    private void initComponents() {
        ...
        espacoDescricao.setToolTipText("Descrição do produto");
        ...
        espacoQuantidade.setToolTipText("Digite a quantidade de produtos");
        ...
        espacoPesquisa.setText("Nome do Produto");
        ...
        espacoProduto.setToolTipText("Nome do produto");
        ...
        jPanel1.add(espacoCompetencia, new org.netbeans.lib.awtextra.AbsoluteConstraints(148, 0, 180, -1));
    ...
    private void botaoDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoDeletarActionPerformed
        String sqlDel = "Delete from produtos_ru where nome_prod=?";
        try {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String sqlUp = "Update produtos_ru set unidade=?,quantidade=?,valor=?,competencia=?where nome_prod=?";
        try {
    ...
    private void botaoPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoPesquisarActionPerformed
        ...
        try {
            ...
            JasperPrint jp = JasperFillManager.fillReport("src\\Relatorio\\Produtos_3_RU_Individual.jasper", null, relat);
    ...
    private void botaoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCadastrarActionPerformed
        String sql = "insert into produtos_ru(unidade,quantidade,valor,nome_prod,competencia) values (?,?,?,?,?)";
        try {
            pst = con.prepareStatement(sql);            
            pst.setString(1, espacoDescricao.getText());
    ...
    private void botaoPesquisar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoPesquisar1ActionPerformed
        try {
            ...
            String sql = "Select * from produtos_ru where nome_prod ILIKE ? ";
            pst = con.prepareStatement(sql);
